                ...
                <form action="{{ url('/goods') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text"
                            ...
                            id="kode_barang" name="kode_barang" placeholder="Kode Barang" required
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text"
                            ...
                            id="nama_barang" name="nama_barang" placeholder="Nama Barang" required
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text"
                            ...
                            id="harga_barang" name="harga_barang" placeholder="Harga Barang" required
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="custom-file mt-1">
                            <input type="file" accept="image/jpeg,image/gif,image/png"
                                class="custom-file-input @error('gambar_barang') is-invalid @enderror" id="customFile"
                                name="gambar_barang" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="date"
                            ...
                            id="kadaluarsa_barang" name="kadaluarsa_barang" required
                            value="{{ old('kadaluarsa_barang') }}">
