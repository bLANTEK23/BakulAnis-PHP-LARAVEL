            ...
            <div class="col-md-12 p-5 bg-white rounded">
                <form action="{{ url('/recap') }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        <label for="kode_barang" class="text-title1 text-blue">Nama Barang</label>
                        <select class="custom-select text-title1 text-blue mt-1 @error('kode_barang') is-invalid @enderror"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="date"
                            ...
                            id="tanggal_rekap" name="tanggal_rekap" placeholder="Tanggal Rekap" required
                            value="{{ old('tanggal_rekap') }}">
                        @error('tanggal_rekap')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text"
                            ...
                            id="stok_awal_rekap" name="stok_awal_rekap" placeholder="Stok Awal" required
                            value="{{ old('stok_awal_rekap') }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text"
                            ...
                            id="stok_akhir_rekap" name="stok_akhir_rekap" placeholder="Stok Akhir" required
                            value="{{ old('stok_akhir_rekap') }}">
